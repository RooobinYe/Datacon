...
# 数据目录，约定读取挂载数据的目录
data_path = "/Users/yezhenrong/Documents/Working/GitHubProjects/Datacon/datacon2024/AI" # 最后需要改掉的
...
# 输出答案的文件
result_path = "/Users/yezhenrong/Documents/Working/GitHubProjects/Datacon/Challenge1/AI_cq1_大模型幻觉触发/docker-cq1/result/result.txt" # 最后需要改掉的
    ...
    try:
        with open(file_path, 'r', encoding='utf-8') as input_file, \
            ...
            for q in input_file:
                ...
                q_star = q.strip() + " Please answer the question without any thought. And don't answer the question over 30 words."  # 生成幻觉
